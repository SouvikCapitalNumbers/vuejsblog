...
/* harmony import */ var _common_Header_vue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../common/Header.vue */ "./resources/js/components/common/Header.vue");
//
//
//
//
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  name: "Register",
  components: {
    Header: _common_Header_vue__WEBPACK_IMPORTED_MODULE_1__["default"]
  },
  data: function data() {
    return {
      form: {
  ...
  methods: {
    submitForm: function submitForm() {
      var _this = this;
      axios__WEBPACK_IMPORTED_MODULE_0___default().post('/api/register', this.form).then(function (res) {
        ...
        (axios__WEBPACK_IMPORTED_MODULE_0___default().defaults).headers.common['Authorization'] = "Bearer " + res.data.token;
        _this.$router.push('/');
                    ...
                    _c(
                      ...
                      [
                        _c("div", { staticClass: "mb-3" }, [
                          _c("label", { staticClass: "mb-2 text-muted" }, [
                            _vm._v("Full Name"),
                          ]),
                          _vm._v(" "),
                          _c("input", {
                  ...
                  _c("div", { staticClass: "card-footer py-3 border-0" }, [
                    _c(
                      ...
                      [
                        ...
                        _c(
                          "router-link",
                          { staticClass: "text-dark", attrs: { to: "/login" } },
                          [_vm._v("Login")]
                        ),
                      ],
                      1
...
var staticRenderFns = [
  function () {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "mb-2 w-100" }, [
      _c("label", { staticClass: "text-muted" }, [_vm._v("Password")]),
    ])
  },
  function () {
    var _vm = this
